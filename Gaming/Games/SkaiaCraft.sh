...
if [[ $testValue = 'active' ]]; then
	...
	LD_PRELOAD=/usr/\$LIB/libgamemodeauto.so java -jar "/home/ccxex29/Other Games/SkaiaLauncherMC/SkaiaCraft Launcher v2.1.jar"
else
	java -jar "/home/ccxex29/Other Games/SkaiaLauncherMC/SkaiaCraft Launcher v2.1.jar"
fi	
