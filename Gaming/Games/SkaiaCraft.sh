...
if [[ $testValue = 'active' ]]; then
	...
	LD_PRELOAD=/usr/\$LIB/libgamemodeauto.so java -jar "$HOME/Other Games/SkaiaLauncherMC/SkaiaCraft Launcher v2.1.jar"
else
	java -jar "$HOME/Other Games/SkaiaLauncherMC/SkaiaCraft Launcher v2.1.jar"
fi	
